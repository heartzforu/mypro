        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className={`w-full p-3 border-2 rounded-lg mt-2 ${errors.name ? "border-red-500" : "border-gray-300"}`}
            />
          ...
          <div>
            ...
            <input
              ...
              value={data.username}
              onChange={handleChange}
              className={`w-full p-3 border-2 rounded-lg mt-2 ${errors.username ? "border-red-500" : "border-gray-300"}`}
            />
          ...
          <div>
            ...
            <input
              ...
              value={data.email}
              onChange={handleChange}
              className={`w-full p-3 border-2 rounded-lg mt-2 ${errors.email ? "border-red-500" : "border-gray-300"}`}
            />
          ...
          <div>
            ...
            <input
              ...
              value={data.password}
              onChange={handleChange}
              className={`w-full p-3 border-2 rounded-lg mt-2 ${errors.password ? "border-red-500" : "border-gray-300"}`}
            />
